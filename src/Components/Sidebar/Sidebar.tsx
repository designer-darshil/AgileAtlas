              ...
              <TooltipTrigger>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `relative ${
                      isActive
                        ? "stroke-black after:bg-white after:w-[2px] after:absolute after:h-full after:top-0 after:-left-10"
                        : "stroke-black"
                    }`
                  }
                >
              ...
              <TooltipTrigger>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `relative ${
                      isActive
                        ? "stroke-[#243c5a] after:bg-white after:w-[2px] after:absolute after:h-full after:top-0 after:-left-10"
                        : "stroke-black"
                    }`
                  }
                >
